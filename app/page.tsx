...
export default function CreatePage() {
  ...
  const [systemInstruction, setSystemInstruction] = useState(
    '당신은 전문 IT 기자입니다. 정확하고 객관적이며 흥미로운 뉴스 기사를 작성해주세요. 기사는 반드시 800자 이상으로 충분히 길고 상세하게 작성해야 합니다. 절대 중간에 끊기지 말고 완전한 기사를 작성해주세요.'
  );
    ...
    try {
      ...
      const model = genAI.getGenerativeModel({
        ...
        generationConfig: {
          ...
          topP: 0.95,
          topK: 40,
          maxOutputTokens: articleLength === 'short' ? 1000 : articleLength === 'standard' ? 2500 : 4000,
        },
      });
      ...
      const personaPrompts = {
        analyst: '당신은 동아일보의 베테랑 논설위원입니다. 냉철하고 깊이 있는 분석으로 독자의 사고를 깊게 만드는 글을 작성해주세요. 기사는 반드시 800자 이상으로 충분히 상세하게 작성하고, 절대 중간에 끊기지 말고 완전한 기사를 작성해주세요.',
        reporter: '당신은 동아일보의 속보팀장입니다. 핵심만 간결하게, 현장감 100%로 생생한 속보를 작성해주세요. 기사는 반드시 800자 이상으로 충분히 상세하게 작성하고, 절대 중간에 끊기지 말고 완전한 기사를 작성해주세요.',
        editor: '당신은 동아일보의 문화부 에디터입니다. 감성적이고 부드러운 에세이 톤으로 독자의 마음을 울리는 글을 작성해주세요. 기사는 반드시 800자 이상으로 충분히 상세하게 작성하고, 절대 중간에 끊기지 말고 완전한 기사를 작성해주세요.',
      };
